MODULE maestcom
    ...
    INTEGER, PARAMETER :: MAXT = 4255        ! Maximum no. of trees in plot
    INTEGER, PARAMETER :: MAXLAY = 15         ! Maximum no. of layers for radiation
    INTEGER, PARAMETER :: MAXSOILLAY = 26    ! Maximum no. of layers of soil (RAD)
    INTEGER, PARAMETER :: MAXSP = 4         ! Maximum no. of species (RAD).
    INTEGER, PARAMETER :: MAXP = 4255        ! Maximum no. of gridpoints -- MUST BE EQUAL TO OR LARGER THAN MAXT !!!!
    INTEGER, PARAMETER :: MAXC = 2            ! Maximum no. of leaf area distributions
    INTEGER, PARAMETER :: MAXANG = 11          ! Maximum no. of zenith & leaf angles
