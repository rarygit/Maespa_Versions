        ...
        MODULE POINTSNEW__genmod
          INTERFACE 
            SUBROUTINE POINTSNEW(NOLAY,PPLAY,JLEAF,JSHAPE,SHAPE,RXNTR,  &
     ...
     &NOAGEC,NOAGEP,XL,YL,ZL,VL,DLT,DLI,LGP,FOLLAY)
              ...
              REAL(KIND=4) :: ZL(4500)
              REAL(KIND=4) :: VL(4500)
              REAL(KIND=4) :: DLT(4500)
              REAL(KIND=4) :: DLI(3,4500)
              INTEGER(KIND=4) :: LGP(4500)
              REAL(KIND=4) :: FOLLAY(15)
            END SUBROUTINE POINTSNEW
          END INTERFACE 
        END MODULE POINTSNEW__genmod
