     ...
     &,SF,PSIV,VPARA,VPARB,VPARC,VFUN,IN_PATH)
              ...
              REAL(KIND=4) :: JMAXTABLE(30,15,3,4)
              INTEGER(KIND=4) :: DATESJ(30,4)
              ...
              REAL(KIND=4) :: DELSJ(4)
              REAL(KIND=4) :: THETA(4)
              REAL(KIND=4) :: VCMAXTABLE(30,15,3,4)
              INTEGER(KIND=4) :: DATESV(30,4)
              ...
              REAL(KIND=4) :: TVJUP(4)
              REAL(KIND=4) :: TVJDN(4)
              REAL(KIND=4) :: SLATABLE(30,15,3,4)
              INTEGER(KIND=4) :: DATESSLA(30,4)
              INTEGER(KIND=4) :: NOSLADATES(4)
              INTEGER(KIND=4) :: NOADATES(4)
              INTEGER(KIND=4) :: DATESA(30,4)
              REAL(KIND=4) :: AJQTABLE(30,15,3,4)
              REAL(KIND=4) :: RDTABLE(30,15,3,4)
              INTEGER(KIND=4) :: DATESRD(30,4)
              ...
              INTEGER(KIND=4) :: DATESFQ(30,4)
              REAL(KIND=4) :: Q10FTABLE(30,4)
              REAL(KIND=4) :: K10F(4)
              INTEGER(KIND=4) :: NOWQDATES(4)
              INTEGER(KIND=4) :: DATESWQ(30,4)
              REAL(KIND=4) :: Q10WTABLE(30,4)
              REAL(KIND=4) :: RMFR(4)
              REAL(KIND=4) :: RMCR(4)
              REAL(KIND=4) :: Q10R(4)
              ...
              REAL(KIND=4) :: G0TABLE(30,4)
              REAL(KIND=4) :: G1TABLE(30,4)
              REAL(KIND=4) :: GK(4)
              INTEGER(KIND=4) :: NOGSDATES(4)
              INTEGER(KIND=4) :: DATESGS(30,4)
              REAL(KIND=4) :: D0L(4)
              REAL(KIND=4) :: GAMMA(4)
              REAL(KIND=4) :: VPDMIN(4)
              REAL(KIND=4) :: WLEAFTABLE(30,4)
              INTEGER(KIND=4) :: DATESWLEAF(30,4)
