     ...
     &PSILTABLE,AREA,AREATOT,ITAR,IPT,TAIR)
              ...
              REAL(KIND=4) :: APARTABLE(5000,4000)
              REAL(KIND=4) :: ANIRTABLE(5000,4000)
              REAL(KIND=4) :: ATHRTABLE(5000,4000)
              REAL(KIND=4) :: ETTABLE(5000,4000)
              REAL(KIND=4) :: HTABLE(5000,4000)
              REAL(KIND=4) :: GSCTABLE(5000,4000)
              REAL(KIND=4) :: PSILTABLE(5000,4000)
              REAL(KIND=4) :: AREA
              REAL(KIND=4) :: AREATOT
              INTEGER(KIND=4) :: ITAR
              INTEGER(KIND=4) :: IPT
