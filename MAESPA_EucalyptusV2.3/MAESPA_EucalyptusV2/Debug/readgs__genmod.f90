     ...
     &DATESWLEAFI,NOWLEAFDATES,G02TABLEI,G12TABLEI,NEWTUZETI)
              ...
              REAL(KIND=4) :: SWPEXPI
              REAL(KIND=4) :: GNIGHTI
              REAL(KIND=4) :: G0TABLEI(1000)
              REAL(KIND=4) :: G1TABLEI(1000)
              REAL(KIND=4) :: GKI
              INTEGER(KIND=4) :: NOGSDATES
              INTEGER(KIND=4) :: DATESGSI(1000)
              REAL(KIND=4) :: D0LI
              REAL(KIND=4) :: GAMMAI
              REAL(KIND=4) :: VPDMINI
              REAL(KIND=4) :: WLEAFTABLEI(1000)
              INTEGER(KIND=4) :: NSIDESI
              REAL(KIND=4) :: SF
              REAL(KIND=4) :: PSIV
              INTEGER(KIND=4) :: DATESWLEAFI(1000)
              INTEGER(KIND=4) :: NOWLEAFDATES
              REAL(KIND=4) :: G02TABLEI(1000)
              REAL(KIND=4) :: G12TABLEI(1000)
