        ...
        MODULE GETMETDAY__genmod
          INTERFACE 
            SUBROUTINE GETMETDAY(IDATE,ZEN,NOMETCOLS,METCOLS,CAK,PRESSK,&
     &SWMIN,SWMAX,DELTAT,ALAT,DEC,DAYL,WINDAH,TSOIL,TAIR,RADABV,FBEAM,RH&
     &,VPD,VMFD,CA,PRESS,PPT,SOILMOIST,SOILDATA,TSOILDATA,EMSKY)
