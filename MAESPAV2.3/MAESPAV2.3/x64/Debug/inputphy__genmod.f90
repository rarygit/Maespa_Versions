     ...
     &G12TABLE,NEWTUZET,IN_PATH)
              ...
              REAL(KIND=4) :: JMAXTABLE(45,15,3,5)
              INTEGER(KIND=4) :: DATESJ(45,5)
              ...
              REAL(KIND=4) :: DELSJ(5)
              REAL(KIND=4) :: THETA(5)
              REAL(KIND=4) :: VCMAXTABLE(45,15,3,5)
              INTEGER(KIND=4) :: DATESV(45,5)
              ...
              REAL(KIND=4) :: TVJUP(5)
              REAL(KIND=4) :: TVJDN(5)
              REAL(KIND=4) :: SLATABLE(45,15,3,5)
              INTEGER(KIND=4) :: DATESSLA(45,5)
              INTEGER(KIND=4) :: NOSLADATES(5)
              INTEGER(KIND=4) :: NOADATES(5)
              INTEGER(KIND=4) :: DATESA(45,5)
              REAL(KIND=4) :: AJQTABLE(45,15,3,5)
              REAL(KIND=4) :: RDTABLE(45,15,3,5)
              INTEGER(KIND=4) :: DATESRD(45,5)
              ...
              INTEGER(KIND=4) :: DATESFQ(45,5)
              REAL(KIND=4) :: Q10FTABLE(45,5)
              REAL(KIND=4) :: K10F(5)
              INTEGER(KIND=4) :: NOWQDATES(5)
              INTEGER(KIND=4) :: DATESWQ(45,5)
              REAL(KIND=4) :: Q10WTABLE(45,5)
              REAL(KIND=4) :: RMFR(5)
              REAL(KIND=4) :: RMCR(5)
              REAL(KIND=4) :: Q10R(5)
              ...
              REAL(KIND=4) :: GNIGHT(5)
              REAL(KIND=4) :: G0TABLE(45,5)
              REAL(KIND=4) :: G1TABLE(45,5)
              REAL(KIND=4) :: GK(5)
              INTEGER(KIND=4) :: NOGSDATES(5)
              INTEGER(KIND=4) :: DATESGS(45,5)
              REAL(KIND=4) :: D0L(5)
              REAL(KIND=4) :: GAMMA(5)
              REAL(KIND=4) :: VPDMIN(5)
              REAL(KIND=4) :: WLEAFTABLE(45,5)
              INTEGER(KIND=4) :: DATESWLEAF(45,5)
              ...
              REAL(KIND=4) :: G02TABLE(45,5)
              REAL(KIND=4) :: G12TABLE(45,5)
