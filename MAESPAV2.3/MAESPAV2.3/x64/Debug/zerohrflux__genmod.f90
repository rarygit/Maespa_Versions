        ...
        MODULE ZEROHRFLUX__genmod
          INTERFACE 
            SUBROUTINE ZEROHRFLUX(APAR,ANIR,ATHR,ALEAF,RD,GSC,GBH,ET,   &
     ...
     &CICAN,ECANMAX,ACANMAX,AREATOT)
              ...
              REAL(KIND=4) :: AREATOT
            END SUBROUTINE ZEROHRFLUX
          END INTERFACE 
        END MODULE ZEROHRFLUX__genmod
