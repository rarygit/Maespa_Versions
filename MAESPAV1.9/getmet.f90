...
!**********************************************************************
    ...
    IF (IOERROR.NE.0) CALL SUBERROR('ERROR READING LATITUDE: IT MUST BE IN MET.DAT',&
                                    IFATAL,IOERROR)
...
!        CALL RHTOVPD(RH,TAIR,VPD)
!        CALL VPDTOMFD(VPD,PRESS,VMFD)
      CALL SUBERROR('TINC NOT SUPPORTED : FAULTY CODE DISABLED, CHECK ALTERMETCC IN GETMET.F90',&
                    IFATAL,-1)
