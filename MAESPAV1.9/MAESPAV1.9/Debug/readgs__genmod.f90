     ...
     &SMD2I,WC1I,WC2I,SWPEXPI,G0TABLEI,G1TABLEI,GKI,NOGSDATES,DATESGSI, &
     &D0LI,GAMMAI,VPDMINI,WLEAFTABLEI,NSIDESI,SF,PSIV,DATESWLEAFI,      &
     &NOWLEAFDATES,G02TABLEI,G12TABLEI,NEWTUZETI)
              ...
              REAL(KIND=4) :: WC2I
              REAL(KIND=4) :: SWPEXPI
              REAL(KIND=4) :: G0TABLEI(30)
              REAL(KIND=4) :: G1TABLEI(30)
              REAL(KIND=4) :: GKI
              INTEGER(KIND=4) :: NOGSDATES
              INTEGER(KIND=4) :: DATESGSI(30)
              REAL(KIND=4) :: D0LI
              REAL(KIND=4) :: GAMMAI
              REAL(KIND=4) :: VPDMINI
              REAL(KIND=4) :: WLEAFTABLEI(30)
              INTEGER(KIND=4) :: NSIDESI
              REAL(KIND=4) :: SF
              REAL(KIND=4) :: PSIV
              INTEGER(KIND=4) :: DATESWLEAFI(30)
              INTEGER(KIND=4) :: NOWLEAFDATES
              REAL(KIND=4) :: G02TABLEI(30)
              REAL(KIND=4) :: G12TABLEI(30)
