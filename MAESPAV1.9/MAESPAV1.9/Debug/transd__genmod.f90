        ...
        MODULE TRANSD__genmod
          INTERFACE 
            SUBROUTINE TRANSD(IDAY,IOTUTD,NEWCANOPY,IPROG,NT,XSLOPE,    &
     &YSLOPE,NZEN,DIFZEN,NAZ,NUMPNT,DEXTT,DIFSKY,XL,YL,ZL,RX,RY,RZ,DXT, &
     &DYT,DZT,XMAX,YMAX,SHADEHT,FOLT,ZBC,JLEAFT,BPTT,NOAGECT,PROPCT,    &
     &JSHAPET,SHAPET,NEWTUTD,TU,TD,RELDF,DEXT)
              INTEGER(KIND=4) :: IDAY
              INTEGER(KIND=4) :: IOTUTD
