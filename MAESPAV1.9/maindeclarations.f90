...
! Array declarations.
    ...
    REAL FRACROOTTABLE(MAXSOILLAY,MAXDATE), POREFRAC(MAXSOILLAY)
...
!    REAL BEXTANGT(MAXP,MAXANG),BEXTANGTUS(MAXP,MAXANG)
    REAL BEXTANGT(MAXT,MAXANG),BEXTANGTUS(MAXT,MAXANG),BEXTANGUS(MAXANG) ! modification 12/2012
    ...
    REAL PLANTKTABLE(maxdate),ROOTRADTABLE(maxdate),ROOTSRLTABLE(maxdate)
    ...
    ! Root front limit
    INTEGER RFAGEBEGIN,ROOTFRONTLIMIT 
    REAL RFPAR1,RFPAR2,RFPAR3,ROOTFRONT
    ...
    REAL XGRID, YGRID,SUNLAGRID, FBEAM2(MAXHRS,3)
