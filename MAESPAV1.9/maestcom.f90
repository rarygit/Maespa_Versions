MODULE maestcom
    ...
    ! Maximum dimensions of arrays      ! Better to put the number of inputs presented in the input files +1 !!!! because of calculations
    ...
    INTEGER, PARAMETER :: MAXHRS = 300 !96 !24*60      ! Maximum number of time periods in a day (ie 15 mins)
