...
!**********************************************************************
    ...
    IF (IOWATBAL.EQ.1 .AND. IOFORMAT .EQ. 0) THEN
        ...
        CALL open_file(trim(out_path)//'swplay.dat', USWPLAY, 'write', 'asc', 'replace')    ! Added outputs, M. Christina December 2012
    ...
    ! Write to sunla flux     !!!!!
      IF(ISUNLA.EQ.1)THEN               ! Added output M. Christina 27/11/12
