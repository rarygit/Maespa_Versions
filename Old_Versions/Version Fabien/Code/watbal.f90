...
! Note that water is not actually taken up yet.
      CALL WATERUPTAKELAYER(SOILWP,SOILRRES1,SOILRRES2, &
                            ...
                            FRACUPTAKE,TOTSOILRES,LAYTHICK) ! Added LAYTHICK to fix bug, M. Christina December 2012
...
!**********************************************************************
    ...
    IF(WATERCONTENT.EQ.0.) THEN
      SOILWPFUN = -999.0           ! Threshold to avoid infinit values which induce NA values for WEIGHTEDSOILWP, M. Christina December 2012
    ELSE 
    ...
    IF(SOILWPFUN.LT.-999) THEN      ! Threshold to avoid infinit value, M. Christina December 2012
        SOILWPFUN = -999.0
    ENDIF
...
!**********************************************************************
      ...
      SUBROUTINE WATERUPTAKELAYER(SOILWP,SOILRRES1,SOILRRES2, &
                                  ...
                                  USEMEASSW, SOILDATA, SOILMOISTURE, &
                                  ROOTLEN,NROOTLAYER,WEIGHTEDSWP, &
                                  FRACUPTAKE,TOTSOILRES,LAYTHICK) ! Added laythick M. Christina, December 2012
...
!**********************************************************************
        ...
        REAL FRACUPTAKE2(MAXSOILLAY), LAYTHICK(MAXSOILLAY)  ! Added laythick M. Christina, December 2012
        ...
        TOTESTEVAP = SUM(ESTEVAP(1:NROOTLAYER))  ! Fix bug, M. Christina, December 2012
        ...
        ELSE
            ...
            WEIGHTEDSWP =0
            DO I=1,NROOTLAYER
                WEIGHTEDSWP = WEIGHTEDSWP + SOILWP(I) * LAYTHICK(I)    ! Modification, M. Christina December 2012
            ENDDO
