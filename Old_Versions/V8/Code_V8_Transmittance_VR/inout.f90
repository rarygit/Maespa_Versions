...
!**********************************************************************
    ...
    IMPLICIT NONE
    INTEGER LEN1,IOERROR,IWATFILE,IUSTFILE, KEEPZEN, IPOINTSI,IPOINTS, ISIMUS,ISIMUSI
    ...
    ! Modified RAD
    NAMELIST /CONTROL/ IOHRLY,IOTUTD,IOHIST,IORESP,IOWATBAL,IOFORMAT,ISUNLA,KEEPZEN,IPOINTS,IUSTFILE
