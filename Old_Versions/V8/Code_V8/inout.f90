...
SUBROUTINE INPUTPHY(NSPECIES,PHYFILES,MODELJM,MODELRD,MODELGS,MODELRW,              &
                    ...
                    SF,PSIV,VPARA,VPARB,VPARC,VFUN,G02TABLESPEC,G12TABLESPEC,NEWTUZET,in_path)
...
!**********************************************************************
    ...
    REAL G02TABLESPEC(MAXDATE,MAXSP),G12TABLESPEC(MAXDATE,MAXSP)
    INTEGER NEWTUZET
    ...
    DO I = 1,NSPECIES
        ...
        CALL READGS(UPHY,I,MODELGS,                                 &
                    ...
                    G02TABLESPEC(1,I),G12TABLESPEC(1,I),NEWTUZET)
